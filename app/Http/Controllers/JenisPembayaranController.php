...
class JenisPembayaranController extends Controller
{
    ...
    {
        $data = JenisPembayaran::findorfail($request->id);
    ...
    {
        if (request()->ajax()) {
            return Datatables::of(JenisPembayaran::get())->addIndexColumn()->addColumn('aksi', function ($data) {
