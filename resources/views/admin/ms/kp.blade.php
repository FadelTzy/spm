...
@section('content')
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Kewenangan Pelaksanaan</li>
                    </ol>
                </nav>
            </div>
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase">Manajemen Data Kewenangan Pelaksanaan </h6>
    ...
    <script>
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/kewenangan-pelaksanaan/' + id,
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
        ...
        $("#editdata").on('submit', function(id) {
            ...
            $.LoadingOverlay("show");
            $.ajax({
                url: '{{ url('admin/kewenangan-pelaksanaan/edit') }}',
                data: new FormData(this),
                type: "POST",
                contentType: false,
                processData: false,
