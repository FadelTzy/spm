                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="tambahdata" class=" form-horizontal form-bordered">
                            ...
                            <br>
                            <label class="form-label">Dasar Pembayaran</label>
                            <div class="input-group">
                                <select class="form-control" name="id_dasar" id="exampleFormControlSelect1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editdata" class=" form-horizontal form-bordered">
                            ...
                            <label class="form-label">Dasar Pembayaran</label>
                            <div class="input-group">
                                <select class="form-control" name="id_dasaru" id="id_dasaru">
                                    <option selected disabled>Pilih Dasar Pembayaran</option>
                            ...
                            <label class="form-label">Tanggal</label>
                            <div class="input-group">
                                <input type="date" id="tanggalu" name="tanggal" placeholder="Input tanggal"
                                    class="form-control" />
...
@push('js')
    ...
    <script>
        ...
        $("#editdata").on('submit', function(id) {
            ...
            $.LoadingOverlay("show");
            $.ajax({
                url: '{{ url('admin/jenis-dokumen/edit') }}',
                data: new FormData(this),
                type: "POST",
                contentType: false,
                processData: false,
        ...
        function staffupd(id) {
            ...
            $('#id_dasaru option[value=' + id.id_dasar_pembayaran + ']').attr('selected', 'selected');
