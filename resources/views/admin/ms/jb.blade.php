...
@section('content')
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Jenis Belanja</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editdata" class=" form-horizontal form-bordered">
                            ...
                            <label class="form-label">Deskripsi</label>
                            <div class="input-group">
                                <textarea class="form-control" name="deskripsi" id="deskripsiu" cols="30" rows="2"></textarea>
                            </div><!-- input-group -->
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase">Manajemen Data Jenis Belanja </h6>
    ...
    <script>
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/jenis-belanja/' + id,
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
