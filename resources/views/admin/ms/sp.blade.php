...
@section('content')
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Sifat Pembayaran</li>
                    </ol>
                </nav>
            </div>
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase">Manajemen Data Sifat Pembayaran </h6>
    ...
    <script>
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/sifat-pembayaran/' + id,
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
        ...
        $("#editdata").on('submit', function(id) {
            ...
            $.LoadingOverlay("show");
            $.ajax({
                url: '{{ url('admin/sifat-pembayaran/edit') }}',
                data: new FormData(this),
                type: "POST",
                contentType: false,
                processData: false,
