...
@section('content')
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Asal Penerimaan</li>
                    </ol>
                </nav>
            </div>
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase">Manajemen Data Asal Penerimaan </h6>
    ...
    <script>
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/asal-penerimaan/' + id,
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
        ...
        $("#editdata").on('submit', function(id) {
            ...
            $.LoadingOverlay("show");
            $.ajax({
                url: '{{ url('admin/asal-penerimaan/edit') }}',
                data: new FormData(this),
                type: "POST",
                contentType: false,
                processData: false,
