...
@section('content')
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Pejabat</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="tambahdata" class=" form-horizontal form-bordered">
                            ...
                            <div class="input-group">
                                <input type="text" name="nip" placeholder="Input NIP" class="form-control" />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editdata" class=" form-horizontal form-bordered">
                            ...
                            <label class="form-label">NIP</label>
                            <div class="input-group">
                                <input type="text" id="nipu" name="nip" placeholder="Input NIP" class="form-control" />
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase">Manajemen Data Pejabat </h6>
...
@push('js')
    ...
    <script>
        ...
        function staffupd(id) {
            ...
            if (id.ttd != null) {
                var html = `<img src="${url + '/gambar/ttd/' + id.ttd}"
